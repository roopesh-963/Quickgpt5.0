...
>
      ...
      <div className="flex items-center gap-2 p-3 mt-4 border border-gray-500 dark:border-white/20 rounded-md">
        ...
        <input
          ...
          className="text-xs bg-transparent outline-none placeholder:text-gray-700"
        />
      </div>
        ...
        {chats
          ...
          .map((chat) => (
            <div onClick={() => {navigate('/'); setSelectedChat(chat); setIsMenuOpen(false)}}
              ...
              className="p-2 px-4 dark:bg-[#57317C]/10 border border-gray-300 dark:border-[#80609F]/15 dark:text-[#3e3870] rounded-md cursor-pointer flex justify-between group"
            >
              <div>
              ...
              <img
                src={assets.bin_icon}
                className="hidden group-hover:block w-4 cursor-pointer not-dark:invert" alt="" onClick={e=> toast.promise(deleteChat(e, chat._id), {loading: 'deleting...'})}
              />
            </div>
          ))}
      </div>
      ...
      <div
        ...
        className="flex items-center gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 dark:text-[#3e3870] rounded-md cursor-pointer hover:scale-105 transition"
      >
      ...
      <div
        ...
        className="flex items-center gap-2 p-3 mt-4 border dark:text-[#3e3870] border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-105 transition"
      >
      ...
      {/* Dark mode */}
      <div className="flex items-center  justify-between gap-2 p-3 mt-4 border dark:text-[#3e3870] border-gray-300 dark:border-white/15 rounded-md">
      ...
      {/* User */}
      <div className="flex items-center gap-3 p-3 mt-4 border dark:text-[#3e3870] border-gray-300 dark:border-white/15 rounded-md cursor-pointer group">
